...
function Arrow({ light = false }: { light?: boolean }) {
  return <Text style={[styles.arrow, light && styles.arrowLight]}>→</Text>;
}
...
function MailIcon({ light = false }: { light?: boolean }) {
  return (
    <View style={[styles.mailIcon, light && styles.mailIconLight]}>
      <View style={[styles.mailLine, light && styles.mailLineLight]} />
    </View>
  );
}
...
export default function CustomerAuth() {
  ...
  const compact = width < 370 || height < 780;
        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <Text style={styles.formSubtitle}>
              {mode === 'login'
                ? 'Sign in to continue with Pickolo.'
                : 'Create your Pickolo account in a few seconds.'}
            </Text>
            ...
            <Pressable
              ...
              disabled={busy}
            >
              <Text style={styles.primaryFormText}>
                {busy
                  ? 'Please wait…'
                  : mode === 'login'
                    ? 'Login'
            ...
            <Pressable onPress={skipAuth} style={styles.formSkip}>
              <Text style={styles.formSkipText}>Continue as Guest</Text>
            </Pressable>
          </View>
        </KeyboardAvoidingView>
      </SafeAreaView>
      ...
      >
        ...
        >
          <View style={styles.copyColumn}>
            ...
            <Text
              style={[styles.heroBlue, compact && styles.heroLineCompact]}
            >
              Memories
            </Text>
            <Text style={[styles.heroLine, compact && styles.heroLineCompact]}>
            ...
            <Text style={[styles.heroSub, compact && styles.heroSubCompact]}>
              Professional photo services at your doorstep in Bhopal.
            </Text>
          </View>
        ...
        <View style={styles.servingPill}>
          <PinIcon />
          <Text style={styles.servingText}>Serving Bhopal & Nearby</Text>
        </View>
        ...
        <Pressable
          ...
          accessibilityRole="button"
          accessibilityLabel="Hire a photographer"
        >
          ...
          <View style={styles.serviceCopy}>
            <Text style={styles.serviceTitle}>Hire a Photographer</Text>
            <Text style={styles.serviceSubtitle}>
              Events, functions, portraits & more
            </Text>
          </View>
