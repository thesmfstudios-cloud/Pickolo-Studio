...
A cancelled booking with a captured payment can enter the full-refund workflow. Refund remains a server/provider operation; the customer app does not calculate or trust refund amounts client-side.
